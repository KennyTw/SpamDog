...
void CUIDlg::DoDataExchange(CDataExchange* pDX)
{
	...
	//{{AFX_DATA_MAP(CUIDlg)
	DDX_Control(pDX, IDC_STATICWP, m_static1);
...
void CUIDlg::OnButton1() 
{
	...
	m_static1.SetWindowText("(INTRASVC)(intrasvc2)Error:<hr>GET/h_manage/h_manage/Tour/TourDesc.asp");
	Invalidate();
	UpdateWindow();
}
